 ...
 * @remark	None.
 */
API int app2sd_usr_pre_app_install(const char *pkgid,
		GList* dir_list, int size, uid_t uid);
API int app2sd_client_usr_pre_app_install(const char *pkgid,
		GList* dir_list, int size, uid_t uid);
 ...
 */
API int app2sd_usr_post_app_install(const char *pkgid,
		app2ext_status install_status, uid_t uid);
API int app2sd_client_usr_post_app_install(const char *pkgid,
		app2ext_status install_status, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_pre_app_upgrade(const char *pkgid,
		GList* dir_list, int size, uid_t uid);
API int app2sd_client_usr_pre_app_upgrade(const char *pkgid,
		GList* dir_list, int size, uid_t uid);
 ...
 */
API int app2sd_usr_post_app_upgrade(const char *pkgid,
		app2ext_status upgrade_status, uid_t uid);
API int app2sd_client_usr_post_app_upgrade(const char *pkgid,
		app2ext_status upgrade_status, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_pre_app_uninstall(const char *pkgid, uid_t uid);
API int app2sd_client_usr_pre_app_uninstall(const char *pkgid, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_post_app_uninstall(const char *pkgid, uid_t uid);
API int app2sd_client_usr_post_app_uninstall(const char *pkgid, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_move_installed_app(const char *pkgid,
		GList* dir_list, app2ext_move_type move_type, uid_t uid);
API int app2sd_client_usr_move_installed_app(const char *pkgid,
		GList* dir_list, app2ext_move_type move_type, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_on_demand_setup_init(const char *pkgid, uid_t uid);
API int app2sd_client_usr_on_demand_setup_init(const char *pkgid, uid_t uid);
 ...
 * @remark	None.
 */
API int app2sd_usr_on_demand_setup_exit(const char *pkgid, uid_t uid);
int app2sd_client_usr_on_demand_setup_exit(const char *pkgid, uid_t uid);

API int app2sd_usr_force_clean(const char *pkgid, uid_t uid);
